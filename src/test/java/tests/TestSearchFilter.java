...
import searchfilterpages.SearchFilterPage;
...
public class TestSearchFilter {
  ...
  public void TestSearchByPayee(){
	  ...
	  List<WebElement> elements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(".//tr/td[4 and text() = 'InternetBill']")));
  ...
  public void TestSearchByAccountAndExpenditurePayee(){
	  ...
	  List<WebElement> elements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(".//tr[(td[4 and text() = 'PowerBill']) and (td[2 and text() = 'Cash'])]")));
