...
import webtablepages.WebTablePage;
...
public class TestWebTable {
	...
	public void testSearchByFirstName(){
		...
		List<WebElement> elements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(".//tr/td[1 and text() = 'Pol']")));
	...
	public void testSearchByLastName(){
		...
		List<WebElement> elements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(".//tr/td[2 and text() = 'Germain']")));
